...
const About = () => {
  return (
    <section
      id="about"
      className="home2-about-section pt-20 bg-[#f4f4f4] dark:bg-[#242627] align-center"
    >
                ...
                <div className="grid grid-cols-12 md:gap-12 gap-0 justify-center">
                  <div className="lg:col-span-4 md:col-span-6 col-span-12 wow animate fadeInLeft delay-200 duration-2000 ease-in-out">
                    <div className="single-countdown flex justify-between items-center flex-col gap-8">
                      ...
                      <div className="content">
                        <p>
                          Giả lập hầu hết toàn bộ các thông số trình duyệt, bảo
                          mật tài khoản tuyệt đối
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="lg:col-span-4 md:col-span-6 col-span-12 wow animate fadeInLeft delay-200 duration-2000 ease-in-out">
                    <div className="single-countdown flex justify-between items-center flex-col gap-8">
                      ...
                      <div className="content">
                        <p>
                          Kho kịch bản phong phú cho nhiều nền tảng phổ biến, dễ
                          dàng triển khai tự động hóa theo nhu cầu.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="lg:col-span-4 md:col-span-6 col-span-12 wow animate fadeInLeft delay-200 duration-2000 ease-in-out">
                    <div className="single-countdown flex justify-between items-center flex-col gap-8">
                      ...
                      <div className="content">
                        <p>
                          Hỗ trợ khách hàng nhiệt tình, chuyên nghiệp, nhanh
                          chóng giải đáp các thắc mắc.
                        </p>
                      </div>
                    </div>
                  </div>
