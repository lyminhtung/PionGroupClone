...
import {
  ...
  squareInstaLogo,
  squareDiscordLogo,
} from "../../../../../public/logo/logo";
const ScriptMarket = () => {
  return (
    <section
      id="script-market"
      className="pt-10 pb-8 px-4 sm:px-6 lg:px-8 bg-[#f4f4f4] dark:bg-[#242627]"
    >
      <div className="container">
        <div className="flex items-center justify-between h-full mb-16 md:gap-0 gap-4">
          <div className="text-start">
            <h2 className="md:text-4xl text-xl font-bold  relative inline-block">
              Chợ Script - Automation đa dạng
            </h2>
          </div>
          <button
            className="bg-black text-white inline-flex items-center justify-center rounded-md transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-primary-foreground shadow hover:bg-primary/90 h-9 size-lg font-bold p-6 md:text-md text-sm text-end"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          />
          <PostCard
            title="Tự động đăng nhập hàng loạt"
