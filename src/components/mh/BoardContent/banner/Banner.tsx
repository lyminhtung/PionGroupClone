      ...
      <div className="container justify-center">
        <div className="grid grid-cols-12 justify-center">
          <div className="col-span-12">
            <div className="banner-content xl:!max-w-[1280px]">
              <h1 className="md:block hidden block hidden text-center">
                ...
                Bảo vệ tài khoản
                <span> </span>
                <span className="index-module_type__E-SaG underline ">
                  {displayedText}
                </span>
              ...
              <p>
                Nền tảng quản lý tài khoản an toàn và tự động hóa thao tác dễ
                dàng cùng kho ứng dụng đa dạng nhất.
              </p>
          ...
          <div className="lg:col-span-10 col-span-12 lg:col-start-2">
            <div className="video">
              <iframe
                className="rounded-t-3xl shadow-t-2xl w-full aspect-video"
                src="https://www.youtube.com/embed/N2vi3OlaJ1I?autoplay=1&amp;mute=1&amp;controls=0&amp;rel=0&amp;showinfo=0&amp;loop=1&amp;playlist=N2vi3OlaJ1I"
