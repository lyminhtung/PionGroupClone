...
const PriceCard: React.FC<PriceCardProps> = ({
  ...
  return (
    <div
      className="relative flex flex-col rounded-lg p-8 bg-[hsl(var(0 0% 100%)] border border-[#e4e4e7] dark:border-[#27272b] h-[500px]"
