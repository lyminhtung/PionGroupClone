...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    ...
    >
      <div className="dark:border bg-white dark:bg-black rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 grid grid-cols-12" style={{marginRight:"30px"}}>
        {/* Icon Section */}
